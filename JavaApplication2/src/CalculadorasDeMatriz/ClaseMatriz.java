...
public class ClaseMatriz {
    ...
    public ClaseMatriz(int row, int col) {
    ...
    public ClaseMatriz transpose() {
        ClaseMatriz transMat = new ClaseMatriz(this.getCols(), this.getRows());
    ...
    public boolean checkAddSub(ClaseMatriz mat){
    ...
    public boolean checkMul(ClaseMatriz mat){
    ...
    public ClaseMatriz Add(ClaseMatriz mat) {
        ClaseMatriz resMat = new ClaseMatriz(this.getRows(), this.getCols());
        if(checkAddSub(mat)){
            for (int i=0;i<this.getRows();i++) {
                for (int j=0;j<this.getCols();j++) {
    ...
    public ClaseMatriz Sub(ClaseMatriz mat) {
        ClaseMatriz resMat = new ClaseMatriz(this.getRows(), this.getCols());
        if(checkAddSub(mat)){
            for (int i=0;i<this.getRows();i++) {
                for (int j=0;j<this.getCols();j++) {
    ...
    public ClaseMatriz scalMul(double scal) {
    ...
    public ClaseMatriz vecMul(ClaseMatriz mat) {
        ClaseMatriz resMat = new ClaseMatriz(this.getRows(), mat.getCols());
        if(checkMul(mat)){
            for (int i = 0; i < this.getRows(); i++) {
    ...
    public ClaseMatriz subMatrix(int remRow, int remCol) {
        ClaseMatriz resMat = new ClaseMatriz(this.getRows()-1, this.getCols()-1);
        int newR = -1;
        for (int i=0;i<this.getRows();i++) {
            if (i==remRow)
                continue;
